        ...
        (<div className='flex justify-around bg-neutral-600 md:p-4 text-white font-bold text-xl items-center '>
                    <div >
                        <ul className='flex md:gap-28 sm:gap-10 '>
                            <li className='cursor-pointer'><FontAwesomeIcon  icon={faLinkedin} size="xl" /></li>
                            <li className='cursor-pointer'><FontAwesomeIcon  icon={faFacebook} size="xl" /></li>
                            <li className='cursor-pointer'><FontAwesomeIcon  icon={faTwitter} size="xl" /></li>
                            <li className='cursor-pointer'><FontAwesomeIcon  icon={faDiscord} size="xl" /></li>
                            <li className='cursor-pointer'><FontAwesomeIcon  icon={faInstagram} size="xl" /></li>
                        </ul>
                    </div>
                </div>
        )
